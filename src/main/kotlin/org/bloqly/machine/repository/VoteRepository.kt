...
interface VoteRepository : CrudRepository<Vote, Long> {
    ...
    fun findBySpaceIdAndValidatorIdAndHeight(spaceId: String, validatorId: String, height: Long): Vote?

    fun existsByValidatorIdAndSpaceIdAndHeight(validatorId: String, spaceId: String, height: Long): Boolean
}