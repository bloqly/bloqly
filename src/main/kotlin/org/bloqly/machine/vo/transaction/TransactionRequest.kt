...
@ApiModel("Transaction argument")
data class Arg(
    @ApiModelProperty(value = "Argument type", allowableValues = "STRING, INT, BIGINT, BOOLEAN", example = "INT")
    val type: String,
    @ApiModelProperty(value = "Argument value", example = "100")
    val value: String
)