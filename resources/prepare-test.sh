...
#validator2
./release/run.sh -database db2 -command "account.import('00B8898555BE47960016E3B5E37D83520188E442BADF3397E4D7CD07D9D54099F4')"

#validator3
./release/run.sh -database db3 -command "account.import('3890ACF98A004E166A864F1444F4425003275DBD1BF84DFCA9F55847BF5E84B4')"

./release/run.sh -database db1 -command "chain.init('main','../src/test/resources/blocks/currency-js')"
./release/run.sh -database db1 -command "block.exportFirst('main')"