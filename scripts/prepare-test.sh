...
GENESIS=$(curl -X GET http://localhost:9911/api/v1/admin/genesis/main)

# import genesis
curl -X POST -H "Content-Type: application/json" -d "$GENESIS" http://127.0.0.1:9912/api/v1/admin/genesis
curl -X POST -H "Content-Type: application/json" -d "$GENESIS" http://127.0.0.1:9913/api/v1/admin/genesis
curl -X POST -H "Content-Type: application/json" -d "$GENESIS" http://127.0.0.1:9914/api/v1/admin/genesis
