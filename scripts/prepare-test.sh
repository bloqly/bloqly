...
curl -X POST \
  ...
  http://127.0.0.1:9901/api/v1/admin/accounts
...
curl -X POST \
  ...
  http://127.0.0.1:9902/api/v1/admin/accounts

#validator3
curl -X POST \
  -H "Content-Type: application/json" \
  -d '{"privateKey":"D17EE6A9EBD5F34DF2FD50D22D89AB5EDDC80A350440E4F40F88D71725B36BA6","password":"validator3 password"}' \
  http://127.0.0.1:9903/api/v1/admin/accounts

#validator4
curl -X POST \
  -H "Content-Type: application/json" \
  -d '{"privateKey":"D7A50269CE3839A2D1AD47E5BE388CEEF1254EFAD613B17CD2224D0D213043DD","password":"validator4 password"}' \
  http://127.0.0.1:9904/api/v1/admin/accounts

# init blockchain
curl -X POST \
  -H "Content-Type: application/json" \
  -d "{\"space\":\"main\", \"path\": \"$(pwd)/src/test/resources/blocks/currency-js\", \"passphrase\":\"root password\"}" \
  http://127.0.0.1:9901/api/v1/admin/blockchain

# export genesis block
GENESIS=$(curl -X GET http://localhost:9901/api/v1/admin/genesis/main)

# import genesis
curl -X POST -H "Content-Type: application/json" -d "$GENESIS" http://127.0.0.1:9902/api/v1/admin/genesis
curl -X POST -H "Content-Type: application/json" -d "$GENESIS" http://127.0.0.1:9903/api/v1/admin/genesis
curl -X POST -H "Content-Type: application/json" -d "$GENESIS" http://127.0.0.1:9904/api/v1/admin/genesis
